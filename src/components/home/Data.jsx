...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Irwing Durán
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitile">Desarrollador Web / Programador   </h3>
        <p className="home__description">
        Me gusta trabajar con startups y crear experiencias web memorables.
        </p>
